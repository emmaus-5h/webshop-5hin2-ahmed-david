...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.description AS description, products.code AS code, products.price AS price, products.quantity AS quantity, products.deliverytime AS DeliveryTime, products.resell AS resell, products.resell, products.instock AS Instock FROM products WHERE id = ?')
